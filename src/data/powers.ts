...
export const CARD_POWERS: Record<string, CardPowerDef> = {
  ...
  'robin-rook': {
    pieceSymbol: 'r', robinRookStay: true, implemented: true, implementedLegendary: true, implementedSpace: true,
    powerLabel: '🏹 Shoot',
    ...
    legendaryPowerLabel: '💣 Cannon',
    legendaryPowerDescription: "Your rook moves like a cannon — it can leap over any single piece in its path to reach squares beyond. Only one piece can be jumped per move.",
  ...
  'crystal-queen': {
    pieceSymbol: 'q', crystalQueenSwap: true, implemented: true, implementedLegendary: true, implementedSpace: true, crystalQueenImmune: true,
    ...
    legendaryPowerLabel: '♟ Pawn Switch',
    legendaryPowerDescription: "Your queen can swap places with any of your own pawns — slide her deep into the action while a pawn takes her throne!",
  ...
  'black-king': {
    pieceSymbol: 'k', blackKingCapture: true, implemented: true, implementedLegendary: true, implementedSpace: true,
    ...
    spacePowerLabel: '🌌 Cosmic King',
    spacePowerDescription: 'Your king moves like a queen — sliding any number of squares in any direction. But beware: if you lose all but 3 of your pieces, you lose the game!',
  },
  'kings-guard': {
    pieceSymbol: 'k', kingsGuardBlock: true, implemented: true, implementedLegendary: true, implementedSpace: true,
    ...
    legendaryPowerLabel: '⚔ Strike Check',
    legendaryPowerDescription: "Instead of moving, any of your pawns can teleport to a square that puts the enemy king in check — strike from anywhere!",
    spacePowerLabel: '🛡 Pawn Wall',
    spacePowerDescription: "Any of your pieces (except pawns) that is adjacent to 3 or more of your own pawns cannot be captured — your pawns form an unbreakable wall!",
  },
  'general-gambit': {
    generalGambitRespawn: true, implemented: true, implementedLegendary: true, implementedSpace: true,
    powerLabel: '♟ Respawn',
    ...
    legendaryPowerLabel: '⚓ Pawn Sacrifice',
    legendaryPowerDescription: "Instead of moving, sacrifice a pawn to instantly teleport any of your other pieces (except the queen) to that square — a bold repositioning at the cost of a pawn!",
  ...
  'chessbeard': {
    chessbeardSacrifice: true, implemented: true, implementedLegendary: true, implementedSpace: true,
    ...
    legendaryPowerLabel: '⚖ Even Trade',
    legendaryPowerDescription: "Sacrifice a piece to destroy an enemy piece of equal or lower value — but only when you're down on material. Fight back from behind!",
